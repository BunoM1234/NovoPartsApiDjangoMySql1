...
from .views import BomsView,BoardInd, ManufacturersView, BoardsView, StockView, UsersView, PartsView, PartPurchaseView
...
urlpatterns=[
    ...
    path('boards/ind/', BoardInd.as_view(), name='boards_lists'),
